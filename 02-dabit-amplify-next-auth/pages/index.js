    ...
    <div>
      <div className='px-4 sm:px-6 md:px-8 mb-14 mt-32 sm:mb-20 xl:mb-8'>
        ...
        <p className='max-w-screen-lg text-lg sm:text-2xl sm:leading-10 font-medium mb-10 sm:mb-11'>
          ...
          <code className='font-mono text-gray-900 font-bold '>flex</code>,{' '}
          <code className='font-mono text-gray-900 font-bold '>pt-4</code>,{' '}
          <code className='font-mono text-gray-900 font-bold '>
            text-center
          </code>{' '}
          and{' '}
          <code className='font-mono text-gray-900 font-bold '>rotate-90</code>{' '}
        ...
        <div className='flex flex-wrap space-y-4 sm:space-y-0 sm:space-x-4 text-center'>
          <Link
            ...
            href='https://github.com/dabit3/next.js-tailwind-authentication'
          >
            Get started
          </Link>
          <button
          ...
          >
            <span className='text-gray-900'>
              ...
              git clone
              git@github.com:dabit3/next.js-tailwind-authentication.git
            </span>
