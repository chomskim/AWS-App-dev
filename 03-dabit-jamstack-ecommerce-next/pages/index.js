...
import { titleIfy, slugify, formatPrice } from '../utils/helpers'
      ...
      <div className='w-full'>
        ...
        >
          <div className='pt-4 pl-2 sm:pt-12 sm:pl-12 flex flex-col'>
            <Tag year={new Date().getFullYear()} category={inventory[2].categories[0]} />
            <Center
              price={formatPrice(inventory[2].price)}
              title={inventory[2].name}
              link={`/product/${slugify(inventory[2].name)}`}
            />
            <Footer designer={inventory[2].brand} />
          </div>
