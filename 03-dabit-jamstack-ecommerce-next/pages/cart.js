...
const Cart = ({ context }) => {
  ...
  const { numberOfItemsInCart, cart, removeFromCart, total, setItemQuantity } = context
      ...
      <div className='flex flex-col items-center pb-10'>
        ...
        >
                    ...
                    <div className='border-b py-10' key={item.id}>
                      <div className='flex items-center hidden md:flex'>
                        ...
                        <div className='flex flex-1 justify-end'>
                          <p className='m-0 pl-10 text-gray-900 tracking-wider'>{formatPrice(item.price)}</p>
                        </div>
                        <div
                          role='button'
          ...
          <div className='flex flex-1 justify-end py-8'>
            ...
            <p className='font-semibold tracking-wide'>{formatPrice(total)}</p>
          </div>
          {!cartEmpty && (
...
function CartWithContext(props) {
  return (
    <ContextProviderComponent>
      <SiteContext.Consumer>{(context) => <Cart {...props} context={context} />}</SiteContext.Consumer>
    </ContextProviderComponent>
  )
}
